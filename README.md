...
Приложение для скачивания музыки из списка плейлиста. Обычно я слушаю подборку музыки с ВК на рабочем месте (на десктопе). Но иногда хочется послушать и в дороге со смарта, однако ВК дает возможность бесплатно в день слушать на смарте только полчаса, для остального надо платить за подписку. Но это случается редко, поэтому платить нет никакого смысла. Нормальных плейеров для ВК, обходящие его парвила, я не нашел, да и не хотелось бы и спользовать такое. Поэтому написал данную программу. Выгружаете плейлист из ВК в текстовый файл, подсовываете данной программе и она ищет эти записи на ютьюбе и скачивает звук в отдельную папку. Конечно, из-за того, что ищет она по названию и автору, а они могут быть на ВК в произвольной форме именованы (например "!!!! ОЧЕНЬ КРУТАЯ ПЕСНЯ !!!"), на ютьюб она может не найтись или найтись что-то другое взамен, но это для меня допустимые ошибки. В репе находится и мой плейлист на полторы тысячи произведений. Конечно, вы можете заполнять файл списка произворльными данными в формате "Певец - Название песни".
